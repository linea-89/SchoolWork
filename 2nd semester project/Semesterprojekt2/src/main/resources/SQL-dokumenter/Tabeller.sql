...
INSERT INTO credit_name (first_name, last_name, address, phone, email, date_of_birth, country, bio, imageurl) VALUES ('Lars', 'Ranthe', 'Bredager Mark 39', 22525248, 'lars@credits.dk', '1969-08-26', 'Danmark', 'Ranthe begyndte sin skuespilkarriere i starten af 1980erne i filmen Gummi Tarzan (1981) og tv-serien Crash: Truslen fra det sorte hul (1984), før han i 1995 blev optaget på Odense Teater, hvor han dimitterede fra som skuespiller i 1998. - https://da.wikipedia.org/wiki/Lars_Ranthe', 'http://rannok.dk//TVCredits/production_images/lars_ranthe_.jpg');
